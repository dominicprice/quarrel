...
class HelpView extends Component {
    render = () => {
        return (
            <div>
                <h3 className="font-bold">Quarrel</h3>
                ...
                <ul className="list-inside list-disc">
                    ...
                    <li>
                        ...
                        grid symmetric. You can also type ? into a cell manually
                        to indicate an unknown letter. For suggestions to
                        complete a word with unknown characters, click the
                        dropdown next to the corresponding clue.
                    </li>
                </ul>
                <hr className="my-2" />
