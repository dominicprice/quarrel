		...
		<>
			<div className="flex-1 flex flex-col mt-8 gap-4 items-center">
				<div className="flex flex-col gap-4 p-4 items-center">
					...
					<div className="w-full md:w-[50vw] p-2 font-serif resize-none italic whitespace-pre-wrap">
						{description}
					</div>
				</div>
				<div className="flex flex-row gap-1 items-center">
					<Stopwatch />
					<div className="flex flex-row rounded shadow group relative border border-neutral-200">
						<div className="material-symbols-outlined p-2 bg-neutral-200 group-hover:bg-neutral-300 select-none">
							visibility
						</div>
						<div className="absolute z-20 bg-white top-10 overflow-hidden h-0 group-hover:h-30 transition-[height] group-hover:border border-neutral-200">
					...
					<div className="flex flex-row rounded shadow group relative">
						<div className="material-symbols-outlined p-2 bg-neutral-200 group-hover:bg-neutral-300 select-none">
							spellcheck
						</div>
						<div className="absolute z-20 bg-white top-10 overflow-hidden h-0 group-hover:h-30 transition-[height] group-hover:border border-neutral-200">
				...
				<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
					<div className="flex flex-col items-center justify-center gap-1 px-4">
						{activeClue && (
							<div className="font-serif px-1 text-sm sm:hidden text-center text-neutral-700">
								{activeClue.num}. {activeClue.clue} ({activeClue.length})
							</div>
						)}
						<div>
							<Grid
					...
					<div className="flex flex-1 flex-col sm:flex-row gap-4 font-serif px-4 text-sm">
						<div className="basis-1/2 p-1">
							...
							<hr />
							<div className="relative border-l-2 border-neutral-200 mt-2 max-h-24 sm:max-h-auto sm:min-h-[50vh] overflow-y-scroll">
								{clues
									...
									.map((clue) => (
										<Clue
											...
											clue={clue.clue}
											num={clue.num}
											onSelected={() => onSelectClue(clue.num, clue.dir)}
