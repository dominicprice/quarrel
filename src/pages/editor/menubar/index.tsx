			...
			>
				<MenuItem level={0} label="File">
					...
					<MenuItem level={1} label="Import">
						<MenuItem level={2} label="JSON" onClick={() => onImport("json")} />
						<MenuItem level={2} label="XML" onClick={() => onImport("xml")} />
						<MenuItem level={2} label="PCN" onClick={() => onImport("pcn")} />
					</MenuItem>
				...
				<MenuItem level={0} label="View">
					<MenuItem level={1} label="Zoom">
						<MenuItem level={2} label="Increase" onClick={() => onZoom(0.1)} />
						<MenuItem level={2} label="Decrease" onClick={() => onZoom(-0.1)} />
						<MenuItem level={2} label="Reset" onClick={() => onZoom(null)} />
					</MenuItem>
					<MenuItem level={1} label="Print Preview" onClick={onPrintPreview} />
				</MenuItem>
				<MenuItem level={0} label="Tools">
					...
					/>
					<MenuItem level={1} label="Word finder" onClick={onWordFinder} />
				</MenuItem>
				<MenuItem level={0} label="Help">
					<MenuItem level={1} label="Guide" onClick={onHelpGuide} />
					<MenuItem level={1} label="Report bug" onClick={onHelpBug} />
