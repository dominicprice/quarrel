	...
	return (
		<div>
			<div className="flex flex-row gap-2">
				<button
					className="bg-lime-600 text-white shadow-sm py-1 px-2"
					onClick={printFn}
				>
					Print
				</button>
			...
			<div className="flex flex-col md:flex-row m-4 gap-8">
				...
				<div className="flex flex-col gap-2">
					...
					<div className="flex flex-row gap-4 items-center">
						...
						/>
						<label htmlFor="showDescriptionCheckbox">Show Description</label>
					</div>
					<div className="flex flex-row gap-4 items-center">
						<input
						...
						/>
						<label htmlFor="showAnswersCheckbox">Show Answers</label>
					</div>
					<div className="flex flex-row gap-4 items-center">
						<input
