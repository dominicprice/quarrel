...
class Cell {
	...
	clue = (dir: Dir) => {
		if (dir == Dir.Across) return this.acrossClue;
		else if (dir == Dir.Down) return this.downClue;
		return null;
	};
	...
	static fromJSON = (json: any) => {
		...
		if (json.downClue !== null) cell.downClue = Clue.fromJSON(json.downClue);
	...
	clone = () => {
		...
		if (this.acrossClue !== null) other.acrossClue = this.acrossClue.clone();
